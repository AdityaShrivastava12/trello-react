...
function ListDiv(props){
  const {idlist,listname,data,setData,handleDragEnter,index} = props;
  ...
  return (
    <div className="list-div" data-idlist={idlist}  data-list-div onDrop={handleDrop} onDragOver={(e) => e.preventDefault()}>
